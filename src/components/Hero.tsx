...
const Hero = () => {
  ...
  return <section className="relative min-h-screen overflow-hidden bg-cover bg-center pt-16" style={{
    ...
    backgroundSize: 'cover'
        ...
        <div className="grid grid-cols-1 gap-8 items-center min-h-[calc(100vh-64px)]">
          <div className="py-24 z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <motion.button onClick={() => scrollToSection('order')} className="btn-primary group relative overflow-hidden" whileHover={{
              scale: 1.05,
              ...
              <motion.button onClick={() => scrollToSection('learn')} className="btn-secondary bg-white/50 backdrop-blur-sm text-natural-800 hover:bg-white/70 group relative overflow-hidden" whileHover={{
              scale: 1.05,
      ...
      {/* Scroll Down Arrow */}
      <motion.div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 cursor-pointer" initial={{
      y: -10,
      opacity: 0
    }} animate={{
      y: 0,
